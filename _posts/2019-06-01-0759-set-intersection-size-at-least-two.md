 ...
 **Minimum intersection set** : of all the intersection sets for a given
...
But how do we find such two elements? If the intervals come in arbitrary
...
Consider **Case 3** last. Can we have either `m_i = m_(i-1)` or `m_i = 1 +
